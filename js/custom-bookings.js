...
const bookingTabSteps = (function () {
    ...
    const renderShoppingCartItems = function () {
        ...
        const normalBikeImgUrl = 'https://mountainbikehurenschoorl.nl/wp-content/themes/mountainbike-huren-schoorl/images/wc-bookings-mountainbike-small-product-image.png';

        const electricBikeImgUrl = 'https://mountainbikehurenschoorl.nl/wp-content/themes/mountainbike-huren-schoorl/images/wc-bookings-e-mountainbike-small-product-image.png';
...
function constructBigYearlySlotsData(resourceIds) {
    ...
    resourceIds.forEach((id) => {
        ...
        var promise = dataService.getResourcesDataById(id).then(resourceData => {
            ...
            const url = `https://mountainbikehurenschoorl.nl/wp-json/wc-bookings/v1/products/slots?&max_date=${maxDate}&resource_ids=${int},${resourceData.id}`;
...
gPostDataStartDateTime.on('change', function () {
    ...
    const newItemHtml = filteredSlots.map(slot => {
        ...
        <div class="item" data-resource-id="${slot.resource_data.id}">
            <div class="image">
                <img src="https://mountainbikehurenschoorl.nl/wp-content/themes/mountainbike-huren-schoorl/images/wc-bookings-mountainbike-small-product-image.png" alt="" />
            </div>
